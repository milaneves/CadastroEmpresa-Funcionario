...
begin
  //criando a variavel conexão sobre o formulario principal e conectando ao banco de dados
...
begin
  //Chamando a tela de Empresa após o evento Onclick
...
begin
  //Chamando a tela de Funcionario após o evento Onclick
...
begin
  //Chamando a tela de localizar após o evento Onclick
